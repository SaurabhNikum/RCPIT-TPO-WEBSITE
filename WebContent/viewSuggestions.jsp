...
<%! final private static Logger log = LoggerFactory.getLogger("viewSuggestions_JSP"); %>
<%
...
<body onload="access()">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<h2>&nbsp&nbspSuggestions for Students</h2>
					<div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered"
							...
							<tbody>
								<tr>
									...
									<td><%=resultSet.getString("SUGGESTION")%></td>
							...
							<%
									...
									log.error("Could not View Suggestions : {}", e);
								}
							%>
