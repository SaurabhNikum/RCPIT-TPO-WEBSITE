...
<%! final private static Logger log = LoggerFactory.getLogger("viewPlacementsTillDateTeachers_JSP"); %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>RCPIT, TPOS</title>
<!-- BOOTSTRAP STYLES-->
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="addSuggestionsForStudents.jsp"><i
							class="fa fa-edit fa-3x"></i>Add Suggestions For Students</a></li>
							...
							<thead>
								...
								<%
									try {
										...
										String sql = "select * from student where SELECTED_IN is not null";
