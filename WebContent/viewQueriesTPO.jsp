...
<%! final private static Logger log = LoggerFactory.getLogger("viewQueriesTPO_JSP"); %>
<%
						...
						<table border="1" id="displaytable" class="table table-bordered"
							...
							<tbody>
								<tr>
									...
									<td><a
										href="answerQuery.jsp?query_id=<%=resultSet.getString("query_id")%>"
										onclick="return confirm_alert(this);">Solve a Query</a></td>
									<td><a
										href="deleteQuery.jsp?query_id=<%=resultSet.getString("query_id")%>"
							...
							<%
									...
									log.error("Could not view queries : {}", e);
								}
							%>
