...
<body onload="access()">
	...
	<div class=" w3l-login-form">
		<h2 style="color: yellow; text-shadow: 0.5px 0.5px 0.5px black;">Company
			Login</h2>
		<form action="CompanyLogin" method="POST">
			...
			<button type="submit"
				style="color: rgb(248, 204, 114); text-shadow: 0.5px 0.5px 0.5px red;">Login</button>

			<div class="col-sm-offset-5 col-sm-10" style="color: yellow;">
				<a href="index.jsp" class="button1">Back To Home Page</a>
			</div>
			<div class="col-sm-offset-5 col-sm-10" style="color: yellow;">
				<a href="forgotPassword.jsp?user=COMPANY" class="button1">ForgotPassword</a>
			</div>
			<br>
