...
<%@page import="services.*"%><%@page import="org.slf4j.LoggerFactory"%>
<%
...
<body onload="access()">
    ...
    <div class=" w3l-login-form">
        <h2 style="color:yellow; text-shadow: 0.5px 0.5px 0.5px black;">Student Login</h2>
        <form action="StudentLogin" method="POST">
			...
			<div class="col-sm-offset-5 col-sm-10" style="color: yellow;">
				<a href="index.jsp" class="button1">Back To Home Page</a>
			</div>
			<div class="col-sm-offset-5 col-sm-10" style="color: yellow;">
				<a href="studentRegister.jsp" class="button1">New Registration</a> 
			</div>
			<div class="col-sm-offset-5 col-sm-10" style="color: yellow;">
				<a href="forgotPassword.jsp" class="button1">Forgot Password?</a>
			</div>
