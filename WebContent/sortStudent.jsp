...
<%! final private static Logger log = LoggerFactory.getLogger("sortStudent_JSP"); %>
<%
...
<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<h2>&nbsp&nbspSorted Students</h2>
					<div class="col-md-12">
						...
						<table border="1" id="displaytable" class="table table-bordered"
							...
							<thead>
								...
								<%
									try {
										...
										String sql = "select * from Student where SSC_MARKS >= '" + UserInfo.getSsc() + "' AND HSC_MARKS >=  '"
												+ UserInfo.getHsc() + "' AND CGPA >=  '" + UserInfo.getCgpa() + "' AND ACTIVE_BACKLOG <=  '" + UserInfo.getActiveBacklogs() +
												"' AND GAP <=  '" + UserInfo.getGaps() + "' AND BRANCH in ('"+String.join("','", UserInfo.getBranch())+"')";
							...
							<%
									...
									log.error("Could not sort students : {}", e);
								}
							%>
	...
	<div
		...
		&nbsp; <a href="menuForAdmin.jsp"
			class="btn btn-danger square-btn-adjust">Back</a>
	</div>
